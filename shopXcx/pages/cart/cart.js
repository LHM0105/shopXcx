...
Page({
  ...
  updateCart: function (productId, goodsId, number, id, updateType, itemIndex) {
    let that = this;
    if(updateType === 'cut'){
    ...
    util.request(api.CartUpdate, {
      ...
      if (res.errno === 0) {
        ...
        let number1 = cartItem.number + 1;
        cartItem.number = number1;
        that.setData({
  ...
  cutNumber: function (event) {
    ...
    this.updateCart(cartItem.product_id, cartItem.goods_id, number, cartItem.id, 'cut');
  },
  addNumber: function (event) {
    ...
    this.updateCart(cartItem.product_id, cartItem.goods_id, number, cartItem.id, 'add', itemIndex);
